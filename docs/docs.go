...
const docTemplate = `{
    ...
    "paths": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/dto.GetFeedbackResponse"
                                            }
                                        }
                                    }
                                }
        ...
        "/api/session/{sessionId}/feedback/{feedbackId}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "dto.CreateProposalRequest": {
            ...
            "properties": {
                "description": {
                    "type": "string",
                    "example": "A conference focused on the latest advancements in technology and innovation."
                },
                "max_seat": {
                    "type": "integer",
                    "example": 100
